...
public class HTMLSchema extends Schema implements HTMLModels {
    public HTMLSchema() {
        ...
        elementType(HHCConverter.object, 1074270212, 37888, 0);
        ...
        elementType(HHCConverter.param, 0, 524288, 0);
        ...
        elementType(HHCConverter.ul, 16384, 4, 0);
        ...
        parent(HHCConverter.object, "body");
        parent("ol", "body");
        parent("optgroup", "select");
        parent("option", "select");
        parent("p", "body");
        parent(HHCConverter.param, HHCConverter.object);
        parent("pre", "body");
        parent("q", "body");
        parent("rb", "body");
        parent("rbc", "body");
        ...
        attribute(HHCConverter.object, "align", "NMTOKEN", null);
        attribute(HHCConverter.object, "declare", "BOOLEAN", null);
        attribute(HHCConverter.object, "tabindex", "NMTOKEN", null);
        ...
        attribute(HHCConverter.param, "valuetype", "CDATA", "data");
        ...
        attribute(HHCConverter.ul, "compact", "BOOLEAN", null);
        attribute(HHCConverter.ul, "type", "NMTOKEN", null);
        ...
        attribute(HHCConverter.object, "class", "NMTOKEN", null);
        ...
        attribute(HHCConverter.param, "class", "NMTOKEN", null);
        ...
        attribute(HHCConverter.ul, "class", "NMTOKEN", null);
        ...
        attribute(HHCConverter.object, "dir", "NMTOKEN", null);
        ...
        attribute(HHCConverter.param, "dir", "NMTOKEN", null);
        ...
        attribute(HHCConverter.ul, "dir", "NMTOKEN", null);
        ...
        attribute(HHCConverter.ul, "id", "ID", null);
        ...
        attribute(HHCConverter.object, "lang", "NMTOKEN", null);
        ...
        attribute(HHCConverter.param, "lang", "NMTOKEN", null);
        ...
        attribute(HHCConverter.ul, "lang", "NMTOKEN", null);
        ...
        entity("eacgr", 941);
        entity("Eacgr", ActivityTxt.DELAY_CURL3D_SHOT2);
        entity("eacute", 233);
        entity("Eacute", 201);
        entity("easter", 10862);
        entity("ecaron", 283);
        ...
        entity("eeacgr", 942);
        entity("EEacgr", 905);
        entity("eegr", ActivityTxt.SCROLL_NO_DELAY);
        entity("EEgr", 919);
        entity("efDot", 8786);
        entity("efr", 120098);
        entity("Efr", 120072);
        ...
        entity("esim", 8770);
        entity("Esim", 10867);
        entity("eta", ActivityTxt.SCROLL_NO_DELAY);
        entity("Eta", 919);
        entity("eth", 240);
        entity("ETH", 208);
        entity("euml", 235);
        ...
        entity("hyphen", 8208);
        entity("iacgr", 943);
        entity("Iacgr", ActivityTxt.DELAY_CURL3D_TOUCH_UP);
        entity("iacute", 237);
        entity("Iacute", 205);
        entity("ic", 8291);
        entity("icirc", 238);
        ...
        entity("ifr", 120102);
        entity("Ifr", 8465);
        entity("igr", ActivityTxt.SET_MARGIN);
        entity("Igr", ActivityTxt.RESTART_CONFIRM_MESSAGE);
        entity("igrave", 236);
        entity("Igrave", 204);
        entity("ii", 8520);
        entity("iiiint", 10764);
        ...
        entity("IJlig", 306);
        entity("Im", 8465);
        entity("imacr", Compress.NC);
        entity("Imacr", Compress.NC20);
        entity("image", 8465);
        ...
        entity("iocy", 1105);
        entity("IOcy", InputDeviceCompat.SOURCE_GAMEPAD);
        entity("iogon", 303);
        entity("Iogon", 302);
        entity("iopf", 120154);
        entity("Iopf", 120128);
        entity("iota", ActivityTxt.SET_MARGIN);
        entity("Iota", ActivityTxt.RESTART_CONFIRM_MESSAGE);
        entity("iprod", 10812);
        entity("iquest", 191);
        entity("iscr", 119998);
        entity("Iscr", 8464);
        ...
        entity("jukcy", 1108);
        entity("Jukcy", 1028);
        entity("kappa", ActivityTxt.CHECK_BOTTOM_HALF_LINE);
        entity("Kappa", ActivityTxt.SYNC_FINISHED);
        entity("kappav", 1008);
        entity("kcedil", 311);
        entity("Kcedil", 310);
        entity("kcy", 1082);
        ...
        entity("kfr", 120104);
        entity("Kfr", 120078);
        entity("kgr", ActivityTxt.CHECK_BOTTOM_HALF_LINE);
        entity("Kgr", ActivityTxt.SYNC_FINISHED);
        entity("kgreen", 312);
        entity("khcy", 1093);
        entity("KHcy", 1061);
        entity("khgr", 967);
        ...
        entity("lagran", 8466);
        entity("lambda", ActivityTxt.PDF_MISS_FONT);
        entity("Lambda", 923);
        entity("lang", 9001);
        entity("Lang", 10218);
        entity("langd", 10641);
        ...
        entity("lg", 8822);
        entity("lgE", 10897);
        entity("lgr", ActivityTxt.PDF_MISS_FONT);
        entity("Lgr", 923);
        entity("lHar", 10594);
        entity("lhard", 8637);
        entity("lharu", 8636);
        ...
        entity("mfr", 120106);
        entity("Mfr", 120080);
        entity("mgr", ActivityTxt.GPU_SHADOW);
        entity("Mgr", 924);
        entity("mho", 8487);
        entity("micro", 181);
        entity("mid", 8739);
        ...
        entity("Mscr", 8499);
        entity("mstpos", 8766);
        entity("mu", ActivityTxt.GPU_SHADOW);
        entity("Mu", 924);
        ...
        entity("nge", 8817);
        entity("ngeq", 8817);
        entity("ngr", ActivityTxt.FORCEFITHARDWAREACCELERATE);
        entity("Ngr", 925);
        entity("ngsim", 8821);
        entity("ngt", 8815);
        entity("ngtr", 8815);
        ...
        entity("nu", ActivityTxt.FORCEFITHARDWAREACCELERATE);
        entity("Nu", 925);
        entity("num", 35);
        entity("numero", 8470);
        entity("numsp", 8199);
        ...
        entity("Ofr", 120082);
        entity("ogon", 731);
        entity("ogr", ActivityTxt.START_AUTOSCROLL_EVENT);
        entity("Ogr", 927);
        entity("ograve", 242);
        entity("Ograve", 210);
        entity("ogt", 10689);
        ...
        entity("omega", 969);
        entity("Omega", 937);
        entity("omicron", ActivityTxt.START_AUTOSCROLL_EVENT);
        entity("Omicron", 927);
        entity("omid", 10678);
        entity("ominus", 8854);
        entity("oopf", 120160);
        ...
        entity("pfr", 120109);
        entity("Pfr", 120083);
        entity("pgr", ActivityTxt.DO_FINISHED);
        entity("Pgr", 928);
        entity("phgr", 966);
        entity("PHgr", 934);
        entity("phi", 981);
        ...
        entity("phmmat", 8499);
        entity("phone", 9742);
        entity("pi", ActivityTxt.DO_FINISHED);
        entity("Pi", 928);
        ...
        entity("rfr", 120111);
        entity("Rfr", 8476);
        entity("rgr", ActivityTxt.ERROR_FINISHED);
        entity("Rgr", 929);
        entity("rHar", 10596);
        entity("rhard", 8641);
        entity("rharu", 8640);
        entity("rharul", 10604);
        entity("rho", ActivityTxt.ERROR_FINISHED);
        entity("Rho", 929);
        entity("rhov", 1009);
        ...
        entity("setmn", 8726);
        entity("sext", 10038);
        entity("sfgr", ActivityTxt.BOOK_INFO_COUNT_DONE);
        entity("sfr", 120112);
        entity("Sfr", 120086);
        entity("sfrown", 8994);
        entity("sgr", 963);
        ...
        entity("sigma", 963);
        entity("Sigma", 931);
        entity("sigmaf", ActivityTxt.BOOK_INFO_COUNT_DONE);
        entity("sigmav", ActivityTxt.BOOK_INFO_COUNT_DONE);
        entity("sim", 8764);
        entity("simdot", 10858);
        entity("sime", 8771);
        entity("simeq", 8771);
        ...
        entity("theta", ActivityTxt.SET_FONT_SIZE);
        entity("Theta", ActivityTxt.SPEAK_PDF_TEXT_REFLOW);
        entity("thetasym", 977);
        entity("thetav", 977);
        entity("thgr", ActivityTxt.SET_FONT_SIZE);
        entity("THgr", ActivityTxt.SPEAK_PDF_TEXT_REFLOW);
        ...
        entity("uacgr", 973);
        entity("Uacgr", ActivityTxt.PRE_LOAD_NEXT_CHAPTER);
        entity("uacute", 250);
        entity("Uacute", 218);
        entity("uarr", 8593);
        entity("uArr", 8657);
        ...
        entity("ugr", 965);
        entity("Ugr", 933);
        entity("ugrave", LZXCoder.NUM_LENGTH_FOOT_VALUE);
        entity("Ugrave", 217);
        entity("uHar", 10595);
        entity("uharl", 8639);
        entity("uharr", 8638);
        ...
        entity("vArr", 8661);
        entity("varrho", 1009);
        entity("varsigma", ActivityTxt.BOOK_INFO_COUNT_DONE);
        entity("vartheta", 977);
        ...
        entity("xfr", 120117);
        entity("Xfr", 120091);
        entity("xgr", ActivityTxt.CHECK_BLUELIGHT_FILTER);
        entity("Xgr", 926);
        entity("xharr", 10231);
        entity("xhArr", 10234);
        entity("xi", ActivityTxt.CHECK_BLUELIGHT_FILTER);
        entity("Xi", 926);
        entity("xlarr", 10229);
        entity("xlArr", 10232);
        entity("xmap", 10236);
        ...
        entity("zeta", ActivityTxt.CHECK_DUAL_PAGE);
        entity("Zeta", 918);
        entity("zfr", 120119);
        entity("Zfr", 8488);
        entity("zgr", ActivityTxt.CHECK_DUAL_PAGE);
        entity("Zgr", 918);
        entity("zhcy", 1078);
        entity("ZHcy", 1046);
        entity("zigrarr", 8669);
